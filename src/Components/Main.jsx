            ...
            <div>
                <div className="bg-[url('https://wallpaperaccess.com/full/128828.jpg')] h-screen relative">
                    ...
                    <div className='w-1/2 top-36 relative pl-20 space-y-4'>
                        ...
                        <div className='space-x-3'>
                            <button className='border p-4 rounded-3xl hover:shadow-md  bg-emerald-400 hover:shadow-emerald-200 hover:bg-emerald-300 '> <Link to='/forestcustom' className='text-emerald-50'>Start Writing</Link> </button>
                            <button className='border p-4 rounded-3xl hover:shadow-md hover:shadow-emerald-600'> <Link className='text-emerald-500 ' to='/'> Log in </Link> </button>
                        </div>
                    </div>
                ...
                <div className='bg-emerald-500'>
                    ...
                    <div className='flex px-24 justify-between space-x-10'>
                        ...
                        <button className='border bg-emerald-300 p-5 rounded-xl hover:shadow-xl hover:shadow-emerald-50 text-emerald-50 '> Explore More </button>
                        </span>
                        <span className=''>
