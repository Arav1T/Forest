...
export default function About() {
    return (
        <div>
            ...
            <Navbar/>
            <div className="bg-[url('https://wallpaperaccess.com/full/128828.jpg')] h-screen  w-screen overflow-hidden p-24 ">
                <h1 className='font-semibold text-xl py-2'>Introduction</h1>
                <p>
                ...
                <h2 className='font-semibold text-xl py-2'>India – Among the Countries with Largest Forest Cover</h2>
                <p>
                ...
                <h2 className='font-semibold text-xl py-2'>Top Forests in India</h2>
                <p>
                ...
                <h2 className='font-semibold text-xl py-2'>The Problem of Deforestation</h2>
                <p>
                ...
                <h2 className='font-semibold text-xl py-2'>Conclusion</h2>
                <p>
